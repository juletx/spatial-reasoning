...
python analysis_scripts/eval_compute_acc_by_rel_meta_cat.py data/splits/zeroshot/test.jsonl results/visualbert_zeroshot.txt analysis_scripts/rel_meta_category_dict.txt > results/visualbert_zeroshot_rel_meta_cat.tsv
...
python analysis_scripts/eval_compute_acc_by_rel_meta_cat.py data/splits/zeroshot/test.jsonl results/lxmert_zeroshot.txt analysis_scripts/rel_meta_category_dict.txt > results/lxmert_zeroshot_rel_meta_cat.tsv
...
python analysis_scripts/eval_compute_acc_by_rel_meta_cat.py data/splits/random/test.jsonl results/blip_nlvr2_random.txt analysis_scripts/rel_meta_category_dict.txt  > results/blip_nlvr2_random_rel_meta_cat.tsv

python analysis_scripts/eval_compute_acc_by_rel_meta_cat.py data/splits/zeroshot/test.jsonl results/blip_nlvr2_zeroshot.txt analysis_scripts/rel_meta_category_dict.txt  > results/blip_nlvr2_zeroshot_rel_meta_cat.tsv