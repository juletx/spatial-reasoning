...
from data.vsr_dataset import vsr_dataset
...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    if dataset=='pretrain':
        ...
        train_dataset = vsr_dataset(transform_train, config['image_root'], config['ann_root'],'train', config['config'])
        val_dataset = vsr_dataset(transform_test, config['image_root'], config['ann_root'],'val', config['config'])
        test_dataset = vsr_dataset(transform_test, config['image_root'], config['ann_root'],'test', config['config'])     
        return train_dataset, val_dataset, test_dataset
