...
\chapter{Zero-shot Winoground Experiments} \label{cha:winoground_zero_shot}
\input chapters/3_winoground_zero_shot
\cleardoublepage

\chapter{Synthetic Dataset Creation} \label{cha:synthetic_dataset}
\input chapters/4_synthetic_dataset
\cleardoublepage

\chapter{Visual Spatial Reasoning} \label{cha:visual_spatial_reasoning}
\input chapters/5_visual_spatial_reasoning
\cleardoublepage
