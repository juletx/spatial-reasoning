Appart from image-text matching, we perform more experiments on Winoground to gain more insight about the dataset and the tested models.
...
\section{Text-to-Image Evaluation}
