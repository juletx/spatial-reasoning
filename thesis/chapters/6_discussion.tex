...
\begin{figure}[ht]
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{figures/pretraining_images_baseline.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{figures/pretraining_captions_baseline.png}}
...
\begin{figure}[ht]
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{figures/pretraining_images_ours.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{figures/pretraining_captions_ours.png}}
    \caption{Graphs of the model performance on Winoground for each model by the number of pretraining images (left) and pretraining captions (right).}
